...
public class LogoutServiceProxyTest
{
    ...
    LogoutRequest passRequest;
    LogoutRequest failRequest;

    LogoutResponse passResponse;
    LogoutResponse failResponse;
    ...
    public void setup() throws IOException, TweeterRemoteException
    {
        ...
        passRequest = new LogoutRequest(resultUser1);
        failRequest = new LogoutRequest(null);

        passResponse = new LogoutResponse(true);
        failResponse = new LogoutResponse(false);
    }
    //pass test
    @Test
    public void passTest() throws IOException, TweeterRemoteException
    {
        LogoutResponse test = logoutServiceProxy.getLogout(passRequest);
    ...
    {
        LogoutResponse test = logoutServiceProxy.getLogout(failRequest);
