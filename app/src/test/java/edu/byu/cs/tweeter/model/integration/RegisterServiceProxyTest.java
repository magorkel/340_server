...
{
    RegisterServiceProxy registerServiceProxy;

    RegisterRequest passRequest;
    RegisterRequest failRequest;

    RegisterResponse passResponse;
    RegisterResponse failResponse;
    ...
    public void setup() throws IOException, TweeterRemoteException
    {
        ...
        passRequest = new RegisterRequest("name","password","firstname","lastname","");
        failRequest = new RegisterRequest(null, null, null, null, "");

        passResponse = new RegisterResponse(user1, new AuthToken("hi"));
        failResponse = new RegisterResponse("failed");
    }
    //pass test
    @Test
    public void passTest() throws IOException, TweeterRemoteException
    {
        RegisterResponse test = registerServiceProxy.getRegister(passRequest);
    ...
    {
        RegisterResponse test = registerServiceProxy.getRegister(failRequest);
