...
class ClientCommunicator {
    ...
    <T> T doPost(String urlPath, final Object requestInfo, Map<String, String> headers, Class<T> returnType)
        ...
        RequestStrategy requestStrategy = new RequestStrategy() {
            ...
            public void sendRequest(HttpURLConnection connection) throws IOException {
                ...
                String entityBody = edu.byu.cs.tweeter.model.net.JsonSerializer.serialize(requestInfo);
        ...
        try {
            ...
            switch (connection.getResponseCode()) {
                case HttpURLConnection.HTTP_OK:
                    ...
                    return edu.byu.cs.tweeter.model.net.JsonSerializer.deserialize(responseString, returnType);
                case HttpURLConnection.HTTP_BAD_REQUEST:
                    ErrorResponse errorResponse = getErrorResponse(connection);
                    throw new edu.byu.cs.tweeter.model.net.TweeterRequestException(errorResponse.errorMessage, errorResponse.errorType, errorResponse.stackTrace);
    ...
    private ErrorResponse getErrorResponse(HttpURLConnection connection) throws IOException {
        ...
        if(responseString == null) {
            ...
            return edu.byu.cs.tweeter.model.net.JsonSerializer.deserialize(responseString, ErrorResponse.class);
        }
    }
